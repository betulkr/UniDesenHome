...
$.widget('ui.spinner', {
	...
	_uiSpinnerHtml: function() {
		return '<div role="spinbutton" class="ui-spinner ui-state-default ui-widget ui-widget-content ui-corner-all" style="width: 55px;"></div>';
	},
	
	_buttonHtml: function() {
		return '<a class="ui-spinner-button ui-spinner-up ui-corner-tr"></a>' +
				'<a class="ui-spinner-button ui-spinner-down ui-corner-br"></a>';
	},
