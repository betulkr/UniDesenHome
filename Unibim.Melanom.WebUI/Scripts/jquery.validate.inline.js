        ...
        return this.each(function () {
            ...
            */
            function buildPrompt(caller, promptText, type, ajaxed) {			// ERROR PROMPT CREATION AND DISPLAY WHEN AN ERROR OCCUR
                ...
                if (promptText == "This field is required." ||promptText == "The No field is required." || promptText == "The DateOfBirth field is required." || promptText == "The Id field is required." || promptText == "The AcademicUnitNo field is required.") {
                    $formErrorContent.html(GLOBAL_VARIABLES.RequiredField);
                }
                else if (promptText == "The Mail field is not a valid e-mail address.") {
                    $formErrorContent.html(GLOBAL_VARIABLES.ValidEmail);
                }
                else {
            ...
            function updatePromptText(caller, promptText, type, ajaxed) {	// UPDATE TEXT ERROR IF AN ERROR IS ALREADY DISPLAYED
                ...
                if (promptText == "The No field is required." || promptText == "The DateOfBirth field is required." || promptText == "The Id field is required." || promptText == "The AcademicUnitNo field is required.") {
                    $updateThisPrompt.find(".formErrorContent").html(GLOBAL_VARIABLES.RequiredField);
                }
                else if (promptText == "The Mail field is not a valid e-mail address.") {
                    $updateThisPrompt.find(".formErrorContent").html(GLOBAL_VARIABLES.ValidEmail);
                }
                else {
