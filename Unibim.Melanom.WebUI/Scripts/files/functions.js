$(function () {
    ...
    $(document).ready(function () {
        ...
        //    if (!$clicked.hasClass("isClicked"))
        //        $('.nav .dropdown > a').next().slideUp(200);
        //});
    ...
    $('.on_off :checkbox, .on_off :radio').iButton({ labelOn: "", labelOff: "", enableDrag: false, allowRadioUncheck: true });
    ...
    $('.onlyFloating input').autotab_magic().autotab_filter({ format: 'custom', pattern: '[-+]?(\d*[.])?\d+' });
    ...
    $(".maskTckn").mask("999 999 999 99");
    $(".maskProd").mask("a*-999-a999", { placeholder: " " });
    $(".maskEye").mask("~9.99 ~9.99 999");
    $(".maskPo").mask("PO: aaa-999-***");
    $(".maskPct").mask("99%");
    $(".maskIBAN").mask("TR-9999-9999-9999-9999-9999-99", { placeholder: " " });
    $(".maskGSM").mask("(599)999-99-99");
    ...
    $('.userNav a.search').click(function () {
        ...
        if ($('.top-userchange-content').is(':visible')) {
            $('.top-userchange-content').fadeOut('fast');
        }
    });
    ...
    $(".acc .whead").click(function (e) {
        if (e.target.localName != "span" && e.target.localName != "a") {
            $(this).css({ color: "#2B6893" }).next("div.menu_body").slideToggle(200).siblings("div.menu_body").slideUp("slow");
            $(this).siblings().css({ color: "#404040" });
        }
    });

    $(".survey .whead").click(function () {
        $(this).css({ color: "#2B6893" }).next("div.menu_body").slideToggle(200).siblings("div.menu_body").slideUp("slow");
        $(this).siblings().css({ color: "#404040" });
    });
    ...
    $("ul.nav li a.allow-submenu").click(function () {
        $(".secNav").toggleClass('display');
    });

    //===== Form elements styling =====//
    $(".select, .check, .check :checkbox").uniform();
});